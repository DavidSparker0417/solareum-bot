...
export const jito_auth_keypairs = [
	Keypair.fromSecretKey(Uint8Array.from(bs58.decode(process.env.JITO_WALLET_TAKAN))),
	Keypair.fromSecretKey(Uint8Array.from(bs58.decode(process.env.JITO_WALLET_TAKAN2))),
]
