...
export const TX_FAILED_CONFIRM = '❌ Transaction failed on confirmation'
export const TX_FETCH_FAILED = '❌ Failed fetching transaction'
export const TX_FAILED_PARSING = '❌ Transaction failed'
export const ADDITIONAL_WALLET_EXISTS = (data: string) => `⚠️ ${data}`

export const MNEMONIC_PLACEHOLDER = 'f867a73290628... or silk master book ...'
export const ADDRESS_PLACEHOLDER = '8SA38hCHTNXB94y9Bzbcq65PrtKEBUgFg9pt92B3Mdpy'
...
export const MANUAL_BUY_TOKEN_LISTENER = 'manual-buy-token-listener'
export const MANUAL_SELL_TOKEN_LISTENER = 'manual-sell-token-listener'
...
export const REFERRAL_LISTENER = 'referral-listener'
export const MIX_LISTENER = 'mix-listener'
export const BRIDGE_LISTENER = 'bridge-listener'
...
export function convertValue(total: string, part: string, BN: any) {
    ...
    if (ret === 'NaN') {
        console.log(`${part}, ${total}, ${val}, ${percentage}`)
