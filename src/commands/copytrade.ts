...
import { getSelectedChain, selectOtherChain } from '../service/connected.chain.service.js';
import { deleteCopyTradeAddress, getCopyTradeDetail, getCopyTradeDetailMarkup, getCopyTradeText, updateCopyTradeAddress } from '../service/copytrade.service.js';
import { processError } from '../service/error.js';
import { COPY_TRADE_LISTENER } from '../utils/common.js';
...
const invokeCopyTrade = async (ctx: any) => {
    ...
    try {
        ...
        const text = await getCopyTradeText(telegramId)
